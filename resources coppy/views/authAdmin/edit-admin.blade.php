...
<div class="container mt-5 pb-5">
    <div class="row justify-content-center">
        ...
        <h2 style="text-align: center;">แก้ไขข้อมูลแอดมิน</h2><hr>
        <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
            <form action="{{url('admin/edit-admin')}}" enctype="multipart/form-data" method="post">@csrf
                ...
                <div class="input-group input-group-alternative">
                    <input class="form-control mitr" placeholder="ชื่อ" type="text" name="name" value="{{$admin->name}}">
                </div>
                </div>
                ...
                <div class="input-group input-group-alternative">
                    <input class="form-control mitr" placeholder="ชื่อเข้าใช้งาน" type="text" name="username" value="{{$admin->username}}">
                </div>
                </div>
                <div class="form-group">
                ...
                <div class="text-center">
                    ...
                    <button type="submit" class="btn btn-primary my-4 mitr">อัพเดตข้อมูลแอดมิน</button>
                </div>
            </form>
            </div>
        </div>
