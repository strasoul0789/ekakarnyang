...
<div class="container mt-5 pb-5">
  <div class="row justify-content-center">
    <div class="col-lg-8 col-md-7">
      <h2 style="text-align: center;">ลงทะเบียนแอดมิน</h2><hr>
      <div class="card bg-secondary shadow border-0">
        <div class="card-body px-lg-5 py-lg-5">
          <form action="{{url('/register-admin')}}" enctype="multipart/form-data" method="post">@csrf
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-primary my-4 mitr">ลงทะเบียนแอดมิน</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <div class="row justify-content-center">
    <div class="col-lg-8 col-md-7 mt-5">
      <h2 style="text-align: center;">ข้อมูลผู้ดูแลระบบ</h2><hr>
      <div class="card bg-secondary shadow border-0">
        <div class="card-body px-lg-5 py-lg-5">
            ...
            <table class="table align-items-center table-flush">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{$value->status}}</td>
                        <td>
                            <a href="{{url('/admin/edit-admin')}}/{{$value->id}}">
                                <i class="ni ni-settings" style="color:blue;"></i>
                            </a>                  
                            <a href="{{url('/admin/delete-admin/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')">
