            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">แก้ไขข้อมูลผ้าเบรก</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{url('/admin/edit-brake')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label">รหัสสินค้า</label>
                                        <input type="text" class="form-control form-control-alternative mitr" name="code" value="{{$brake->code}}" readonly>
                                    </div>
                                </div>
                            </div>
                            @php
                                $carbrand = DB::table('carbrands')->where('id',$brake->brand_id)->value('brand');
                                $carmodel = DB::table('carmodels')->where('id',$brake->model_id)->value('model');
                            @endphp
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="brand_id" id="brand" class="form-control form-control-alternative mitr">
                                                <option value="{{$brake->brand_id}}">{{$carbrand}}</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="model_id" id="model" class="form-control form-control-alternative mitr">
                                            <option value="{{$brake->model_id}}">{{$carmodel}}</option>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-alternative mitr" name="year" value="{{$brake->year}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="brand" class="form-control form-control-alternative mitr">
                                            <option value="{{$brake->brand}}">{{$brake->brand}}</option>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input type="text" class="form-control form-control-alternative mitr" name="name" value="{{$brake->name}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control form-control-alternative mitr">
                                            <option value="{{$brake->status}}">{{$brake->status}}</option>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group mt--4">
                                        ...
                                        <button type="submit" class="btn btn-primary my-4 mitr">อัพเดตรายการผ้าเบรก</button>
                                    </div>
                                </div>
                            </div>
                        </div>
