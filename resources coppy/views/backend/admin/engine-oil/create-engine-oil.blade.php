            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">เพิ่มรายการน้ำมันเครื่อง</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    @php
                        ...
                        $code_gen = 'EG-'.$random_format;

                        $code = DB::table('engine_oils')->where('code',$code_gen)->value('code');
                            if($code == null) {
                                $code = $code_gen; 
                            } else {
                                $random = rand(11111,99999);  
                    ...
                    @endphp
                    <form action="{{url('/admin/create-engine-oil')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input type="text" class="form-control form-control-alternative mitr" placeholder="กรุณากรอกชื่อสินค้า" name="name">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group mt--4">
                                        ...
                                        <button type="submit" class="btn btn-primary my-4 mitr">เพิ่มรายการน้ำมันเครื่อง</button>
                                    </div>
                                </div>
                            </div>
                        </div>
