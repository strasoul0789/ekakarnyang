...
<div class="container-fluid mt-5">
    <h1>ค้นหายางตามขนาดยาง ราคาทุน</h1>
    <form action="{{url('/admin/search-tyre-cost-price')}}" enctype="multipart/form-data" method="post">@csrf
        <div class="row">
            <div class="col-lg-3">
    ...
    <form action="{{url('/admin/search-cost-tyre-brand-price')}}" enctype="multipart/form-data" method="post">@csrf
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                @php
                                    ...
                                    $price_format = number_format($cost_price);
                                    $comment = DB::table('tyre_cost_prices')->where('tyre_id',$value->id)->orderBy('id','desc')->value('comment');
                                @endphp
                                <tr>
                                    ...
                                    <td>       
                                        ...
                                        <a href="{{url('/admin/tyre-cost-price-detail')}}/{{$value->id}}">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">แก้ไขราคาต้นทุนยางรถยนต์</h5>
                                        </div>
                                        <form action="{{url('/admin/edit-tyre-cost-price')}}" enctype="multipart/form-data" method="post">@csrf
                                            <input type="hidden" name="id" value="{{$value->id}}">
                                            <div class="modal-body">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>ราคาต้นทุนยางรถยนต์ล่าสุด</label>
                                                        @if ($errors->has('cost_price'))
                                                            <span class="text-danger" style="font-size: 16px;">{{ $errors->first('cost_price') }}</span>
                                                        @endif
