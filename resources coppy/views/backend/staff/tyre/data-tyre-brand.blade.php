...
<div class="container-fluid mt-5">
    <center><h1>ยางรถยนต์ {{$brand}}</h1></center>
    <div class="row">                       
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <h1 style="border-bottom: 3px solid #00902b; width:15.5rem;">ค้นหายางตามขนาดยาง โชว์</h1><br>
                    <form action="{{url('/staff/search-tyre-model')}}/{{$brand}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="row">
                            <div class="col-lg-3">
    ...
    <div class="mt-5">
        ...
        <h1>ยางรถเก๋ง รถสปอร์ต</h1><br>
        <div class="row">
            @foreach($model_sedans as $model_sedan => $value)
            <div class="col-xl-2 col-6"> 
                <a href="{{url('/staff/data-tyre')}}/{{$brand}}/{{$value->model}}" class="bttn">
                    {{$value->model}}
                </a>
            </div>
            @endforeach
        ...
        <h1>ยาง SUV รถอเนกประสงค์</h1><br>
        <div class="row">
        ...
        @if(count($model_runflats) != 0)
        <h1>ยางรันแฟลต</h1><br>
        <div class="row">
            @foreach($model_runflats as $model_runflat => $value)
            <div class="col-xl-2 col-6"> 
                <a href="{{url('/staff/data-tyre')}}/{{$brand}}/{{$value->model}}" class="bttn">
                    {{$value->model}}
                </a>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('/image_upload/image_model_tyre')}}/{{$image}}" style="width:100px;">
                                    </td>
                                    <td>{{$model}}</td>
