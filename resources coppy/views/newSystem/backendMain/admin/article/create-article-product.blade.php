            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">เพิ่มบทความสินค้า</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{url('/admin/create-article-product')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="pl-lg-4">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$value->status}}</td>
                                    <td>
                                        <a href="{{url('/admin/edit-article-product/')}}/{{$value->id}}">
                                            <i class="fas fa-edit" style="color:blue;"></i>
                                        </a>                  
                                        <a href="{{url('/admin/delete-article-product/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')">
