            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">เพิ่มบทความ</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{url('/admin/create-article-service')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="service" class="form-control form-control-alternative mitr">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$value->status}}</td>
                                    <td>
                                        <a href="{{url('/admin/edit-article-service/')}}/{{$value->id}}">
                                            <i class="fas fa-edit" style="color:blue;"></i>
                                        </a>                  
                                        <a href="{{url('/admin/delete-article-service/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')">
