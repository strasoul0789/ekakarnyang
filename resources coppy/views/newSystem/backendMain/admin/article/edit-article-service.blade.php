            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">แก้ไขบทความบริการ</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body"> 
                    <form action="{{url('/admin/edit-article-service')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="service" class="form-control form-control-alternative mitr">
                                                <option value="{{$article->service}}">{{$article->service}}</option>
                                ...
                                <div class="col-lg-4 mt-2">
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary my-4 mitr">อัพเดตบทความบริการ</button>
                                    </div>
                                </div>
                            </div>
                        </div>
