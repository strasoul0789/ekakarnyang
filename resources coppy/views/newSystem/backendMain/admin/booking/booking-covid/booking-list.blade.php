...
<div class="container-fluid mt-7">
    <div class="row">
        <div class="col-md-4">
            <form action="{{url('/admin/search-booking-covid-19')}}" enctype="multipart/form-data" method="post">@csrf
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{url('/admin/edit-booking-covid-19')}}/{{$value->id}}">
                                        ...
                                        <a href="{{url('/admin/booking-covid-19-detail')}}/{{$value->id}}">
