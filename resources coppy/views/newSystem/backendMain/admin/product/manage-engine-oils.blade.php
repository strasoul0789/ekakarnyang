...
<div class="container-fluid mt-5">
    <a href="{{url('/admin/engine-oil')}}" class="btn btn-success">ข้อมูลน้ำมันเครื่อง</a>
    <a href="{{url('/admin/create-engine-oil')}}" class="btn btn-success">เพิ่มน้ำมันเครื่อง</a>
    <a href="{{url('/admin/engine-oil-price')}}" class="btn btn-success">จัดการราคาขาย</a>
</div>
<div class="container-fluid mt-5">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$value->status}}</td>
                                    <td>
                                        <a href="{{url('/admin/edit-engine-oil')}}/{{$value->id}}">
                                            <i class="ni ni-settings" style="color:blue;"></i>
                                        </a>                  
                                        <a href="{{url('/admin/delete-engine-oil/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')">
