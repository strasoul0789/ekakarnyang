    ...
    <div class="row justify-content-center">
        <div class="col-xl-8 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form action="{{url('/admin/create-brand-max')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="pl-lg-4">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$value->brand}}</td>
                                    <td>
                                        <img src="{{url('image_upload/image_brand_max')}}/{{$value->image}}" class="img-responsive" width="100px;">
                                    </td>
                                    <td>
                                        <a data-toggle="modal" data-target="#EditBrand{{$value->id}}">
                                            <i class="fas fa-edit" style="color:blue;"></i>
                                        </a>                  
                                        <a href="{{url('/admin/delete-brand-max/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')">
                            ...
                            <div class="modal fade" id="EditBrand{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{url('/admin/edit-brand-max')}}" enctype="multipart/form-data" method="post">@csrf
                                            <input type="hidden" name="id" value="{{$value->id}}">
