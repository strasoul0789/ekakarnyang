    ...
    <div class="row justify-content-center">
        <div class="col-xl-8 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form action="{{url('/admin/create-model-max')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mt--4">
                                        @php
                                            $category_id = DB::table('product_categories')->where('name',"แม็กซ์")->value('id');
                                        @endphp
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$value->model}}</td>
                                    <td>
                                        <img src="{{url('image_upload/image_model_max')}}/{{$value->image}}" class="img-responsive" width="100px;">
                                    </td>
                                    <td>{{$value->status}}</td>
                                    <td>
                                        ...
                                        <a href="{{url('/admin/delete-model-max/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')">
                            ...
                            <div class="modal fade" id="EditModel{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{url('/admin/edit-model-max')}}" enctype="multipart/form-data" method="post">@csrf
                                            <input type="hidden" name="id" value="{{$value->id}}">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="subcategory_id" class="form-control form-control-alternative mitr">
                                                            @php
                                                                $brand_max_id = DB::table('maxbrands')->where('brand',$brand)->value('id');
                                                            @endphp
                                                                <option value="{{$brand_max_id}}">{{$brand}}</option>
                                                            @foreach ($brand_maxs as $brand_max => $value)
                                                                <option value="{{$value->id}}">{{$value->brand}}</option>
                                                            @endforeach
                                                        </select>
