            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">สร้างยี่ห้อสินค้า นะคะ</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{url('/admin/create-brand-tyre')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="pl-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        @if ($errors->has('logo'))
                                            <span class="text-danger" style="font-size: 16px;">{{ $errors->first('image') }}</span>
                                        @endif
                                        <input type="file" class="form-control form-control-alternative mitr" placeholder="รูปภาพโลโก้" name="logo">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$value->brand}}</td>
                                    <td>
                                        <img src="{{url('image_upload/image_brand_tyre')}}/{{$value->image}}" class="img-responsive" width="100px;">
                                    </td>
                                    <td>
                                        <img src="{{url('image_upload/image_brand_tyre')}}/{{$value->logo}}" class="img-responsive" width="100px;">
                                    </td>
                                    <td>
                                        <a data-toggle="modal" data-target="#EditBrand{{$value->id}}">
                                            <i class="fas fa-edit" style="color:blue;"></i>
                                        </a>                  
                                        <a href="{{url('/admin/delete-brand-tyre/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')">
                            ...
                            <div class="modal fade" id="EditBrand{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{url('/admin/edit-brand-tyre')}}" enctype="multipart/form-data" method="post">@csrf
                                            <input type="hidden" name="id" value="{{$value->id}}">
                                            <div class="modal-body">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label>รูปภาพโลโก้สินค้า</label>
                                                        <input type="file" class="form-control form-control-alternative mitr" placeholder="รูปภาพโลโก้สินค้า" name="logo">
                                                    </div>
                                                </div>
                                            </div>
