    ...
    <div class="row justify-content-center">
        <div class="col-xl-8 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form action="{{url('/admin/create-model-tyre')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="pl-lg-4">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('/admin/delete-model-tyre/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')">
                            ...
                            <div class="modal fade" id="EditModel{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{url('/admin/edit-model-tyre')}}" enctype="multipart/form-data" method="post">@csrf
                                            <input type="hidden" name="id" value="{{$value->id}}">
                                            <div class="modal-body">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="subcategory_id" class="form-control form-control-alternative mitr">
                                                            @php
                                                                $brand_tyre_id = DB::table('product_brands')->where('brand',$brand)->value('id');
                                                            @endphp
                                                                <option value="{{$brand_tyre_id}}">{{$brand}}</option>
                                                            @foreach ($brand_tyres as $brand_tyre => $value)
                                                                <option value="{{$value->id}}">{{$value->brand}}</option>
                                                            @endforeach
                                                        </select>
