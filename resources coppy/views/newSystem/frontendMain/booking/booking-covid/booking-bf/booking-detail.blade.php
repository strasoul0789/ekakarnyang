        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="{{url('/booking-bf-covid-19')}}" enctype="multipart/form-data" id="demo1" class="frm" method="post" autocomplete="off">@csrf
                        ...
                        <div style="border-radius: 25px; border: 2px solid #2c6ed5; padding: 20px; margin-top:20px;">
                            <center><h3 class="title">ข้อมูลการลงทะเบียนจองสิทธิ์ซื้อยางรถยนต์ยี่ห้อบีเอฟกู๊ดริช</h2></center>
                            <center><h3><a style="color: red;" href="{{url('/bf-covid-19')}}">คลิ๊กเพื่อแก้ไข เปลี่ยนแปลง ยี่ห้อยาง หรือขนาดยางรถยนต์</a></h3></center><br>
                        ...
                        <div class="p-t-20"> 
                            ...
                            <input type="hidden" name="brand" value="BF Goodrich">
