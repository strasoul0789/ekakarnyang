    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <center><img class="img-logo" src="{{ asset('/images/tyres/otani_logo.png')}}" class="img-responsive" style="width:50%;"></center>
                    <center><h2 class="kanit">ลงทะเบียนจองสิทธิ์ซื้อยางรถยนต์ยี่ห้อโอตานิ</h2></center>
                    <center><h4 class="title" style="color: red;">(สิทธิพิเศษสำหรับรถป้ายเขียว-ป้ายเหลืองเท่านั้น)</h4></center>
                    <center><h3 class="kanit">น้ำใจโอตานิช่วยเหลือผู้ประกอบการ</h3></center>
                    <center><h3 class="title kanit">เพื่อส่งเสริมการท่องเที่ยวภายในจังหวัดภูเก็ต และพังงา</h3></center>
                    <center><h4 class="kanit">คนไทยไม่ทิ้งกัน ลงทะเบียนจองสิทธิ์ซื้อยางโอตานิ 2 แถม 2 ทุกรุ่น ทุกขนาด</h4></center>
                    <form action="{{url('/booking-otani-covid-19')}}" enctype="multipart/form-data" id="demo1" class="frm" method="post" autocomplete="off">@csrf
                        ...
                        <div style="border-radius: 25px; border: 2px solid #2c6ed5; padding: 20px; margin-top:20px;">
                            <center><h3 class="title">ข้อมูลการจองยางรถยนต์ยี่ห้อโอตานิ</h2></center>
                            <center><h3><a style="color: red;" href="{{url('/otani-covid-19')}}">คลิ๊กเพื่อแก้ไข เปลี่ยนแปลง ยี่ห้อยาง หรือขนาดยางรถยนต์</a></h3></center><br>
                            ...
                            <div style="border-radius: 25px; border: 2px solid #2c6ed5; padding: 9px; margin-top:10px; text-align:center;">
                                ...
                                @endphp
                                <h4>ราคายาง 4 เส้น {{$sumTotal}} บาท</h4>
                                <h3 style="color: red;">ราคาโปรโมชั่น 2 แถม 2 เหลือ {{$promotion}} บาท</h3>
                        ...
                        <div style="border-radius: 25px; border: 2px solid #2c6ed5; padding: 20px; margin-top:20px;">
                            <center><h3 class="title kanit">ข้อตกลงและเงื่อนไขในการลงทะเบียนจองสิทธิ์ซื้อยางรถยนต์ยี่ห้อโอตานิ</h3></center>
                            ...
                            <p class="kanit" style="font-size:15px;"><i class="fa fa-angle-double-right"></i> ลงทะเบียนจองสิทธิ์ซื้อยางรถยนต์ยี่ห้อโอตานิผ่านระบบออนไลน์ ทุกรุ่น ทุกขนาด 2 แถม 2 จำกัดการลงทะเบียน 1 ท่าน / 1 สิทธิ์ / 1 คัน เท่านั้น</p>
                            <p class="kanit" style="font-size:15px;"><i class="fa fa-angle-double-right"></i> ชื่อผู้ลงทะเบียนจองสิทธิ์ซื้อยางต้องตรงกับผู้ที่รับเข้าบริการ พร้อมแสดงบัตรประจำตัวประชาชน</p>
                            <p class="kanit" style="font-size:15px;"><i class="fa fa-angle-double-right"></i> สามารถเปลี่ยนได้ที่ร้านตัวแทนจำหน่ายยางโอตานิอย่างเป็นทางการในจังหวัดภูเก็ต-พังงา เท่านั้น</p>
                        ...
                        <div class="p-t-20"> 
                            ...
                            <input type="hidden" name="brand" value="OTANI">
