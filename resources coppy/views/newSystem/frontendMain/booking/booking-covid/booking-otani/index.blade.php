            ...
            <div class="card card-1">
                <div class="card-body" >
                    ...
                    <div style="border-radius: 25px; border: 2px solid #2c6ed5; padding: 20px; margin-top:20px;">
                        <center><h3><a style="color: red;" class="kanit" href="{{url('/otani-covid-19')}}">คลิ๊ก ที่นี่ เพื่อเลือกรุ่น และขนาดยางรถยนต์</a></h3></center>
                    </div>
                    <div style="border-radius: 25px; border: 2px solid #2c6ed5; padding: 20px; margin-top:20px;">
                    ...
                    <center><h2 class="kanit" style="color: red;">>> ปิดลงทะเบียนจองสิทธิ์ซื้อยางรถยนต์ยี่ห้อโอตานิ <<</h2></center>
                </div>
            </div>
        </div>
    </div>
