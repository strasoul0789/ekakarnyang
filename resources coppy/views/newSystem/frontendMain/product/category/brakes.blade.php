...
<div class="container mt-5">
    <div style="border-bottom: 3px solid #00902b;" class="mb-5">
        <div class="title-bg"><h1 class="kanit" style="text-align:center; color:#ffffff; font-size:22px; margin-top:10px;">ผ้าเบรกตามยี่ห้อรถ</h1></div>
    </div>
        ...
        @foreach ($brands as $brand => $value)
            ...
            @if(count($models) != 0)
                <div class="col-md-3 mt-5">
                    <a href="{{url('/carbrand-brake')}}/{{$value->brand}}"><img src="{{url('image_upload/image_brand_car')}}/{{$value->image}}" class="img-responsive"></a>
                </div>
            @endif
        @endforeach
    </div>
