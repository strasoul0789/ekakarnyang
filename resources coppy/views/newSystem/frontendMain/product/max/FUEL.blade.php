...
<body style="background-color: #363636;">
    <img src="{{url('images/maxs/fuel/fuel.png')}}" class="img-responsive">
    <div style="margin: 3rem;">
        ...
        <div class="row mt-5">
            <div class="col-md-4">
                <div style="text-align: left !important;"><img src="{{url('images/maxs/fuel/fuel-footer.png')}}" width="100%"></div> 
            </div>
            <div class="col-md-6" style="margin-top: 10rem;">
                <div style="text-align: center !important;"><h1 style="color: #fff; font-size: 7rem;">FUEL OFF-ROAD</h1></div>
                <center><h2 style="color: #fff; line-height:1.8;">FUEL OFF-ROAD ล้อแม็กซ์สไตล์ออฟโรด ถูกออกแบบมาให้มีความทันสมัย เรียบหรู โดดเด่นไม่เหมือนใคร ตรงกับความต้องการของลูกค้าที่ชอบการแต่งรถสไตล์ออฟโรด</h2></center>
