...
<div class="container mt-5">
    <div style="border-bottom: 3px solid #00902b;" class="mb-5">
        <div class="title-bg"><h1 class="kanit" style="text-align:center; color:#ffffff; font-size:22px; margin-top:10px;">น้ำมันเครื่องตามรุ่นรถ</h1></div>
    </div>
    ...
    <div class="row">
        ...
        @foreach ($carmodels as $carmodel => $value)
            ...
            <div class="col-lg-3 col-xl-3 col-md-3">
                <a href="{{url('/product-oil')}}/{{$brand}}/{{$value->model}}" class="bttn">
                    {{$value->model}}
                </a>
            </div>
        @endforeach
